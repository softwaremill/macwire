...
libraryDependencies += "com.softwaremill.macwire" %% "macrosakka" % "2.5.6" % "provided"

libraryDependencies += "com.softwaremill.macwire" %% "util" % "2.5.6"

libraryDependencies += "com.softwaremill.macwire" %% "proxy" % "2.5.6"
````
