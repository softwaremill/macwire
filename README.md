...
````scala
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "1.0.4"

libraryDependencies += "com.softwaremill.macwire" %% "runtime" % "1.0.4"
````
...
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "1.0.5-SNAPSHOT"

libraryDependencies += "com.softwaremill.macwire" %% "runtime" % "1.0.5-SNAPSHOT"
````
