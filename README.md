...
````scala
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "2.2.4" % "provided"

libraryDependencies += "com.softwaremill.macwire" %% "util" % "2.2.4"
                  
libraryDependencies += "com.softwaremill.macwire" %% "proxy" % "2.2.4"
````
