...
````scala
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "2.5.2" % "provided"

libraryDependencies += "com.softwaremill.macwire" %% "macrosakka" % "2.5.2" % "provided"

libraryDependencies += "com.softwaremill.macwire" %% "util" % "2.5.2"

libraryDependencies += "com.softwaremill.macwire" %% "proxy" % "2.5.2"
````
