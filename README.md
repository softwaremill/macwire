...
````scala
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "1.0.2"
...
libraryDependencies += "com.softwaremill.macwire" %% "macros" % "1.0.3-SNAPSHOT"

libraryDependencies += "com.softwaremill.macwire" %% "runtime" % "1.0.3-SNAPSHOT"
````
